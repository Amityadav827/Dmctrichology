...
function StatusDropdown({ value, options, onChange, disabled = false }) {
  ...
  return (
    <div className="relative w-full min-w-[120px]" ref={dropdownRef}>
      <button
        type="button"
        disabled={disabled}
      ...
      {isOpen && (
        <div className="absolute left-0 top-full mt-1.5 w-full min-w-[130px] bg-white border border-slate-100 rounded-xl shadow-2xl z-[100] overflow-hidden animate-in fade-in zoom-in duration-200">
          <div className="p-1 max-h-[160px] overflow-y-auto scrollbar-hide space-y-0.5">
            {options.map((opt) => {
